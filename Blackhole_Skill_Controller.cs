...
public class Blackhole_Skill_Controller : MonoBehaviour
{
    ...
    public bool canCreatHotKeys = true;
    ...
    public void SetupBlackhole(float _maxSize, float _growSpeed, float _shrinkSpeed, int _amountOfAttacks, float _cloneAttackCooldown, float _blackholeDuration)
    {
        ...
        if (SkillManger.instance.clone.crystalInseadOfClone)
    ...
    private void CloneAttackLogic()
    {
        if (cloneAttackTimer < 0 && cloneAttackReleased && amountOfAttacks > 0)
        {
            ...
            {
                SkillManger.instance.clone.CreatClone(targets[randomIndex], new Vector3(xOffset, 0));
            }

            if (targets.Count > 0)
            {
                SkillManger.instance.clone.CreatClone(targets[randomIndex], new Vector3(xOffset, 0, 0));
                amountOfAttacks--;
    ...
    private void CreatHotKey(Collider2D collision)
    {
        ...
        Blackhole_HotKet_Controller newHotKeyScript = newHotKey.GetComponent<Blackhole_HotKet_Controller>();
